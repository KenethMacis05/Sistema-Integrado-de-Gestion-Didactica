...
CREATE TABLE MENU (
	...
	controlador VARCHAR(60) NOT NULL, -- Ej: 'Home'
	vista VARCHAR(50) NOT NULL, -- Ej: 'Index'
    icono VARCHAR(60), -- Ej: 'fa-home'
    estado BIT DEFAULT 1,
    fecha_registro DATETIME DEFAULT GETDATE()
)
GO
...
CREATE TABLE PERMISOS (
    ...
    CONSTRAINT FK_PERMISOS_SUBMENU FOREIGN KEY (fk_menu) REFERENCES MENU(id_menu) ON DELETE CASCADE
)
GO
